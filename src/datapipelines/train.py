...
@register_pipeline("sf_xl_gsvcities_0p30_train", category="train")
def build_sf_xl_gsvcities_0p30_train() -> Pipeline:
    name = "sf_xl_gsvcities_0p30_train"
    return Pipeline(
        name,
        steps=[
            ReadTrainImagesStep(
...
@register_pipeline("sf_xl_gsvcities_0p20_train", category="train")
def build_sf_xl_gsvcities_0p30_train() -> Pipeline:
    name = "sf_xl_gsvcities_0p20_train"
    return Pipeline(
        name,
        steps=[
            ReadTrainImagesStep(
