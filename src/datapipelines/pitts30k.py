...
def _data_root():
    """Deferred so raw_dir() is only called when a pitts30k pipeline runs."""
    return [
        raw_dir() / "pitts30k/images/train/queries",
    ]


@register_pipeline("pitts30k", category="train")
def build_pitts30k() -> Pipeline:
    name = "pitts30k"
    return Pipeline(
        name,
        steps=[
            ReadTrainImagesStep(data_root=_data_root()),
...
@register_pipeline("pitts30k_intra", category="train")
def build_pitts30k_intra() -> Pipeline:
    name = "pitts30k_intra"
    return Pipeline(
        name,
        steps=[
...
@register_pipeline("pitts30k_inter", category="train")
def build_pitts30k_inter() -> Pipeline:
    name = "pitts30k_inter"
    return Pipeline(
        name,
        steps=[
...
@register_pipeline("pitts30k_intra_inter", category="train")
def build_pitts30k_intra_inter() -> Pipeline:
    name = "pitts30k_intra_inter"
    return Pipeline(
        name,
        steps=[
            ReadTrainImagesStep(data_root=_data_root()),
...
@register_pipeline("pitts30k_diverse_intra_inter", category="train")
def build_pitts30k_diverse_intra_inter() -> Pipeline:
    name = "pitts30k_diverse_intra_inter"
    return Pipeline(
        name,
        steps=[
            ReadTrainImagesStep(data_root=_data_root()),
...
@register_pipeline("pitts30k_cosplace", category="train")
def build_pitts30k_cosplace() -> Pipeline:
    name = "pitts30k_cosplace"
    return Pipeline(
        name,
        steps=[
            ReadTrainImagesStep(data_root=_data_root()),
...
@register_pipeline("pitts30k_eigenplaces", category="train")
def build_pitts30k_eigenplaces() -> Pipeline:
    name = "pitts30k_eigenplaces"
    return Pipeline(
        name,
        steps=[
            ReadTrainImagesStep(data_root=_data_root()),
